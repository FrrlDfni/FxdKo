...
const youtube = ('https://www.youtube.com/@MaxxyBotz')
const wa = `0@s.whatsapp.net`
const owner = global.owner + '@s.whatsapp.net'
const nyoutube = ('MaxxyBotz') 
...
https://danzzapi.xyz (danzz)`
      	  let buttons = [
                ...
                let buttonMessage = {
                    image: { url: 'https://telegra.ph/file/fe06bb7e5433c18f00e6a.jpg' },
                    caption: `${tqto}`,
                    footer: `${tag}\n\n${global.wm}`,
                    buttons: buttons,
                    headerType: 4
